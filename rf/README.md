...
`colosseum-equipment`; trace analysis and derived metrics in `col.shared.signal` (TDD).

Each topic folder shares `bench.toml.example` + `README.md`; every script is one
...
| `colosseum-shared` | Savitzky–Golay trace analysis, S-param extrema, OIP3/P1dB (TDD) |

See [docs/target_apis.md](../docs/target_apis.md) for TDD contracts and the
...
- [suites/rf_passband.toml.example](../suites/rf_passband.toml.example) — S21, S11, gain flatness
- [suites/rf_linearity.toml.example](../suites/rf_linearity.toml.example) — P1dB, IM3, OIP3
- [suites/rf_amplifier.toml.example](../suites/rf_amplifier.toml.example) — broader RF acceptance
