...
Each topic folder has a shared `config.toml.example`, `README.md` (block index),
and
...
| Plugin | Used for |
| --- | --- |
| `colosseum-equipment` | `col.io.dio`, `col.io.i2c/spi/jtag/onewire` (...)` |
| `colosseum-shared` | `col.shar... |
