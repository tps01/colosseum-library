...
- This library is copy-out testware (not a pip package). When documenting installs
  for Colosseum plugins, point at that single full install — never optional extras.
